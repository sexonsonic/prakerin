        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('kelurahan.create') }}" class="btn btn-success mb-3 float-right"><i
                                ...
                                <tbody>
                                    ...
                                    @foreach ($kelurahan as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <center>{{ $data->nama_kelurahan }}</center>
                                            </td>
                                            <td>
                                                <center>{{ $data->kecamatan->nama_kecamatan }}</center>
                                            </td>
                                                ...
                                                <form action="{{ route('kelurahan.destroy', $data->id) }}" method="POST">
                                                    ...
                                                    <a href="{{ route('kelurahan.edit', $data->id) }}"
                                                        class="btn btn-outline-primary btn-sm"><i class="fa fa-edit">
                                                            Edit</i></a>
                                                    <a href="{{ route('kelurahan.show', $data->id) }}"
