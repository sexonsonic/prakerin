    ...
    <main id="main">
                            ...
                            <tbody>
                                ...
                                @foreach ($tampil as $tmp)
                                    <tr>
                                        ...
                                        <td>
                                            <center>{{ number_format($tmp->jml_positif) }}</center>
                                        </td>
                                        <td>
                                            <center>{{ number_format($tmp->jml_sembuh) }}</center>
                                        </td>
                                        <td>
                                            <center>{{ number_format($tmp->jml_meninggal) }}</center>
                                        </td>
                                    </tr>
        ...
        <section id="services" class="services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-3  d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-out"
                        data-aos-delay="100">
                        <div class="icon-box">
        ...
        <section id="faq" class="faq section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <ul class="faq-list" data-aos="fade-up" data-aos-delay="100">
                    <li>
                        <a data-toggle="collapse" class="" href="#faq1">Apa itu Coronavirus atau Covid-19? <i
                                class="icofont-simple-up"></i></a>
                        <div id="faq1" class="collapse" data-parent=".faq-list">
                            <p>
                                Virus korona adalah sebutan untuk jenis virus yang dapat menyebabkan penyakit pada hewan
                                dan manusia.
                                Disebut korona karena bentuknya yang seperti mahkota (korona ~ crown = mahkota dalam
                                bahasa Latin).
                            </p>
                        </div>
                    </li>
                    <li>
                        <a data-toggle="collapse" href="#faq2" class="collapsed">Bagaimana COVID-19 menular? <i
                                class="icofont-simple-up"></i></a>
                        <div id="faq2" class="collapse" data-parent=".faq-list">
                            <p>
                                Penularan terjadi melalui droplet (butir-butir tetesan cairan) dari hidung atau mulut
                                yang menyebar saat pembawa virus COVID-19 batuk, bersin atau meler.
                                Tetesan cairan tersebut akan menempel pada benda atau permukaan di sekitarnya. Dan
                                kemudian masuk ke mulut, hidung atau mata.
                                Atau menyentuh permukaan bekas terkena butir cairannya dengan tangan lalu tangan
                                mengusap mulut, hidung atau mata.
                                Inilah alasan pentingnya sering-sering cuci tangan dan jangan menyentuh muka dengan
                                tangan. <br>

                                Orang sehat dapat tertular saat tangan mereka menyentuh permukaan yang terkena tetesan
                                tersebut dan kemudian tanpa sadar menyentuh mata,
                                mulut, ataupun hidung (selaput lendir). Virus juga bisa masuk saat orang sehat secara
                                tidak sengaja menghirup tetesan cairan saat si pembawa virus batuk atau bersin.
                            </p>
                        </div>
                    </li>
                    <li>
                        <a data-toggle="collapse" href="#faq3" class="collapsed">Kita harus bagaimana? <i
                                class="icofont-simple-up"></i></a>
                        <div id="faq3" class="collapse" data-parent=".faq-list">
                            <p>
                                1. Ketika keluar rumah, pakailah masker. Jika bersin, tutup mulut dan hidung dengan tisu
                                dan buang tisunya sesegera mungkin. <br>
                                2. Rajinlah mencuci tangan dengan sabun atau pembersih tangan berbasis alkohol min. 60%
                                <br>
                                3. Jaga jarak dengan orang yang tampak sakit sepanjang kurang lebih 1 meter <br>
                                4. Jika sakit, pastikan untuk tidak menyebarkan virus ke orang lain dengan mengurangi
                                bepergian.
                            </p>
                        </div>
                    </li>
                    <li>
                        <a data-toggle="collapse" href="#faq4" class="collapsed">Jika seseorang terinfeksi virus ini,
                            berapa lama sampai muncul gejala? <i class="icofont-simple-up"></i></a>
                        <div id="faq4" class="collapse" data-parent=".faq-list">
                            <p>
                                Masa inkubasi (dari masuknya virus ke dalam tubuh sampai munculnya gejala awal) adalah 1
                                – 14 hari, dengan rata-rata timbulnya gejala selama 5 hari.
                            </p>
                        </div>
                    </li>
                    <li>
                        <a data-toggle="collapse" href="#faq5" class="collapsed">Seberapa banyak pasien yang akan
                            mengalami gejala serius? <i class="icofont-simple-up"></i></a>
                        <div id="faq5" class="collapse" data-parent=".faq-list">
                            <p>
                                Dari data yang tersedia saat ini, kita belum bisa menyimpulkan secara persis seberapa
                                parah wabah COVID-19 ini.
                                Tingkat keparahan dan mortalitas suatu wabah juga akan sangat tergantung pada kapasitas
                                sistem kesehatan publik setempat dalam menangani kasus yang ada.
                                Namun, temuan awal mengindikasikan bahwa tingkat keparahan COVID-19 lebih rendah
                                dibandingkan SARS.
                                Berdasarkan data dari 44 ribu pasien yang dirilis oleh Centre of Disease Control di
                                Tiongkok,
                                proporsi pasien dengan gejala ringan/serius/kritis dan tingkat kematiannya adalah
                                sebagai berikut: <br><br>
                                -Gejala ringan seperti flu biasa: 81% (tingkat kematian: 0) <br>
                                -Gejala lebih serius seperti sesak napas dan pneumonia (radang paru-paru): 14% (tingkat
                                kematian: 0) <br>
                                -Perlu masuk ICU dengan kondisi kritis karena gagal pernapasan, syok septik, dan gagal
                                multi-organ: 5% (tingkat kematian: 50%)
                            </p>
                        </div>
                    </li>
                    <li>
                        <a data-toggle="collapse" href="#faq6" class="collapsed">Apa yang harus saya sampaikan kepada
                            tenaga medis jika saya batuk pilek demam dan sulit bernafas? <i
                                class="icofont-simple-up"></i></a>
                        <div id="faq6" class="collapse" data-parent=".faq-list">
                            <p>
                                1. Riwayat perjalanan (jika ada, ke Tiongkok atau negara-negara yang sudah terjangkit
                                COVID-19, seperti Singapura, Jepang, Korea Selatan, dan Italia) <br>
                                2. Kapan gejala mulai timbul <br>
                                3. Adakah kontak selama 14 hari terakhir dengan seseorang yang memiliki gejala
                                pernapasan dan baru datang dari salah satu daerah yang ditemukan memiliki kasus COVID-19
                            </p>
                        </div>
                    </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-8 footer-links">
                        ...
                        <p>Ini diantaranya media sosial kami</p>
