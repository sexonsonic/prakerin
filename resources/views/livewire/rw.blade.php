<div>
    <div class="form-group">
        <div>
            ...
            <select wire:model="selectedProvinsi" class="form-control select2" name="id_provinsi">
    ...
    <div class="form-group">
        <div>
            @if (!is_null($selectedKecamatan))
                ...
                <select wire:model="selectedKelurahan" class="form-control select2" name="id_kelurahan">
